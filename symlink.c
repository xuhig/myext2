...
static void *myext2_follow_link(struct dentry *dentry, struct nameidata *nd)
{
	struct myext2_inode_info *ei = MYEXT2_I(dentry->d_inode);
...
const struct inode_operations myext2_fast_symlink_inode_operations = {
	.readlink	= generic_readlink,
	.follow_link	= myext2_follow_link,
	.setattr	= myext2_setattr,
#ifdef CONFIG_MYEXT2_FS_XATTR
	.setxattr	= generic_setxattr,
	.getxattr	= generic_getxattr,
